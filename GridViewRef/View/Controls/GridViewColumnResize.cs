        ...
        public class ListViewResizeBehavior
        {
            ...
            private void Resize()
            {
                if (Enabled)
                {
                    ...
                    var gv = _element.View as System.Windows.Controls.GridView;
                    if (gv != null)
                    {
            ...
            private static IEnumerable<GridViewColumnResizeBehavior> GridViewColumnResizeBehaviors(System.Windows.Controls.GridView gv)
            {
            ...
            private static double GetAllocatedSpace(System.Windows.Controls.GridView gv)
            {
                double totalWidth = 0;
                foreach (GridViewColumn t in gv.Columns)
                {
